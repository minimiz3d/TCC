...
static const u4_t DEVADDR = 0x26031A32; // <-- Change this address for every node!
...
static uint8_t mydata[] = "AVAILABLE SPACES: 0/2";
...
void do_send(osjob_t *j) {
    ...
    Serial.print(" - Canal de transmissão: ");
...
// frequency is not configured here.
    ...
    for (uint8_t i = 0; i < 9; i++) {
        if (i != CHANNEL) {
            Serial.print("$$$ Desabilitando canal: ");
            Serial.println(i);
